        ...
        <div class="row m-0">
          ...
          <div class="row m-0">
              <div class="col-6 pr-2">
                  <button type="button" name="button" class="btn btn-secondary font-16 btn-lg btn-block">Go back</button>
              </div>
              <div class="col-6 pl-2">
                  <button type="button" name="button" class="btn btn-primary font-16 btn-lg btn-block">Yep!</button>
              </div>
          </div>
      </section>
    </div>
